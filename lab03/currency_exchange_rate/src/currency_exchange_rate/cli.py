...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data-dir", default=str(Path(__file__).resolve().parents[2] / "data"),
                        help="Directory to save responses (default: ./data)")
    parser.add_argument("--log-dir", default=str(Path(__file__).resolve().parents[2] / "logs/app.log"),
...
def main() -> int:
    ...
    logger_setup.init_logger(log_path=args.log_dir)
